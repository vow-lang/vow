...
inserted only in the clone. The adapter receives the original operands and adds
the caller-side operation plus a saturating synthetic cost with the helper's
