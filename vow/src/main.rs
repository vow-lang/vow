...
```json
{
  ...
  "$defs": {
    ...
    "Vow": {
      "description": "Vow-surface metrics (experimental tier). Grows in Phase 3 (effects, linear_values, contract).",
      "type": "object",
      "required": ["tier", "linear_consumes", "linear_borrows"],
      "properties": {
        "tier": { "const": "experimental" },
    ...
    "Function": {
      "type": "object",
      "required": ["name", "line", "complexity_score", "score_factors", "size", "structural", "vow"],
      "properties": {
        "name": { "type": "string" },
