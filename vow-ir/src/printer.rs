...
fn opcode_name(opcode: &Opcode) -> &'static str {
    match opcode {
        ...
        Opcode::And => "And",
        Opcode::Or => "Or",
        Opcode::BitAndI64 => "BitAndI64",
        Opcode::BitOrI64 => "BitOrI64",
        Opcode::XorI32 => "XorI32",
        Opcode::XorI64 => "XorI64",
        Opcode::ShlI64 => "ShlI64",
        Opcode::ShrI64 => "ShrI64",
        ...
        Opcode::GtU64 => "GtU64",
        Opcode::GeU64 => "GeU64",
        Opcode::BitAndU64 => "BitAndU64",
        Opcode::BitOrU64 => "BitOrU64",
        Opcode::XorU64 => "XorU64",
        Opcode::ShlU64 => "ShlU64",
        Opcode::ShrU64 => "ShrU64",
